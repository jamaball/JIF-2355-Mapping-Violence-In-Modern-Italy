...
export default function App() {
  return (
    <div>
      ...
      <input id='slider' name = 'sliderInput' class= "white" type='range' min='1500' max='1900' step='10' value='1700' onchange="updateTextInput(this.value);" oninput="amount.value=sliderInput.value" />
